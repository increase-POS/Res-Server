                ...
                using (incposdbEntities entity = new incposdbEntities())
                {
                    var List = (from S in entity.residentialSectorsUsers
                                ...
                                select new UserModel()
                                {
                                    ...
                                    password = JUU.password,
                                    name = JUU.name,
                                    lastname = JUU.lastname,
                                    fullName = JUU.name + " " + JUU.lastname,
                                    job = JUU.job,
                                    workHours = JUU.workHours,
                                    createDate = JUU.createDate,
                                    updateDate = JUU.updateDate,
                                    createUserId = JUU.createUserId,
                                    updateUserId = JUU.updateUserId,
                                    phone = JUU.phone,
                                    mobile = JUU.mobile,
                                    email = JUU.email,
                                    notes = JUU.notes,
                                    address = JUU.address,
                                    isActive = JUU.isActive,
                                    isOnline = JUU.isOnline,
                                    image = JUU.image,
                                    balance = JUU.balance,
                                    balanceType = JUU.balanceType,
                                    isAdmin = JUU.isAdmin,
                                    driverIsAvailable = JUU.driverIsAvailable,
